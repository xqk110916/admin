  ...
  <div id="edit_phone">
    ...
    <el-form :model="ruleForm2" status-icon :rules="rules2" ref="ruleForm2" label-width="100px" class="demo-ruleForm" label-position="right">
      ...
      <el-form-item label="邮箱" prop="phone">
        <el-input v-model="ruleForm2.email" placeholder="请输入你要添加的邮箱"></el-input> 
  ...
  export default {
    ...
    methods: {
      getyzm(){
        ...
        axios.post('client/sendValCode.do',this.qs.stringify({
          pe: this.ruleForm2.email,
			    verificationCodeType: 'ADD_LOGIN_EMAIL_CODE'
        })).then(result => {
      ...
      submitForm(formName) {
        ...
        if(this.can){
          axios.post('client/addClientLoginEmail.do',this.qs.stringify({
